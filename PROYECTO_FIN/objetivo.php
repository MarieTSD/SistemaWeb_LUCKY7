...
<!-- Codigo LOGIN-->  
   ...
   <!-- Hero section -->
    <section class="hero3 hero5">
      ...
      <h1 class="hero__title">OBJETIVO</h1>
      <p class="hero__paragraph">Ofrecer ropa de mejor calidad, satisfaga las  necesidades y gustos del mercado potencial, vender ropa a la moda que cumpla con los requerimientos de estilo en el segmento  del mercado.</p>
    </section>
    <!-- End Hero section -->
