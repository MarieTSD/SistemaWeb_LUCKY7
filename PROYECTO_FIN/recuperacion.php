...
<!-- /MENU ACCESIBILIDAD -->
    ...
    ?>
	 ...
	 <!-- Dropdown -->
		  ...
		  <li class="nav-item">
			<a id="menu_item" class="nav-link" href="carrito.php"><i class="fas fa-shopping-cart"></i></a>
		  </li>
...
<!-- Codigo LOGIN-->  
   ...
   <!-- Hero section -->
    <section class="hero3 hero9">
     	<!--SMACSS-->
     	<!--BEM BLOVK ELEMENT MODIFIER-->
<!--      <h1 class="hero__title"></h1>-->
      <p class="hero__paragraph">Recupera tu cuenta</p>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
      <div class="wrap-input100 validate-input; contact100-form validate-form;" data-validate="Name is required">
<!--					<span class="label-input100">ID:</span>-->
					<input class="input100" type="text" name="correo" placeholder="Ingresa correo">
					<span class="focus-input100"></span>
      </div>
      <div class="wrap-input100 validate-input; contact100-form validate-form;" data-validate="Name is required">
<!--					<span class="label-input100">ID:</span>-->
					<input class="input100" type="text" name="des" placeholder="Ingresa codigo de debloqueo">
					<span class="focus-input100"></span>
      </div>
      <div class="wrap-input100 validate-input; contact100-form validate-form;" data-validate="Name is required">
<!--					<span class="label-input100">ID:</span>-->
					<input class="input100" type="password" name="contra" placeholder="Ingresa nueva contraseña">
					<span class="focus-input100"></span>
      </div>
      <div class="wrap-input100 validate-input; contact100-form validate-form;" data-validate="Name is required">
<!--					<span class="label-input100">ID:</span>-->
					<input class="input100" type="password" name="contra2" placeholder="Confirma contraseña">
					<span class="focus-input100"></span>
      </div>
    ...
    <?php
     ...
     $BaseD = 'lucky7';
      ...
      if(isset($_POST['submit'])){
          $modificar = $_POST['correo'];
          $modificar2 = $_POST['des'];
          $modificar3 = $_POST['contra'];
          $modificar4 = $_POST['contra2'];
          //$_SESSION['correo']=$modificar;
          $sql2 = "select * from usuario where correo='$modificar'";
          $resultado = $conexion -> query($sql2); 
           while( $fila = $resultado -> fetch_assoc() ){
                $id = $fila['id'];   
                $nombre = $fila['nombre'];
                $correo = $fila['correo'];
                $desbloqueo = $fila['codigoDes'];
           }
            if(($correo == $modificar) && ($modificar2 == $desbloqueo) && ($modificar3 == $modificar4)){
                 $serv = 'localhost';
                     $cuenta = 'root';
                     $contra = '';
                     $BaseD = 'lucky7';
      ...
      //Realiar la conexion con la base de datos 
              $conexion2 = new mysqli($serv,$cuenta,$contra,$BaseD);
                $con = password_hash($modificar3, PASSWORD_DEFAULT);
                $estado = 1;
                $des = "";
                $ne="update usuario set contra='$con', estado='$estado', codigoDes='$des' WHERE correo='$modificar'";
               $fin = $conexion2 -> query($ne);
             if ($conexion2->affected_rows >= 1){
//                 echo '<script>swal("Recuperacion de cuenta exitoso", "Nueva contraseña actualizada, continua navegando", "success");</script>';
                    echo "<script>
                 ...
                 echo '<center>';
                          ...
                          echo '<strong>¡Ocurrio un error!</strong>';
            ...
            }else if($modificar3 != $modificar4){
                echo '<script>swal("Las contraseñas no coinciden", "Las contraseñas ingresadas no coinciden, intentalo de nuevo", "error");</script>';
            }else{
                echo '<script>swal("Los datos no coinciden", "Correo electronico y/o codigo incorrectos", "error");</script>';
            }    
       }
      }
