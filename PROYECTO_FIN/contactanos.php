...
<!-- Codigo LOGIN-->  
    ...
    <section class="pb_xl_py_cover overflow-hidden cover-bg-opacity-9"  style="background-image: url(img/fondo4.png)">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-5 justify-content-center">
            <h2 style="font-weight: bold;" class="heading mb-5 pb_font-50">CONTACTANOS</h2>
            <div class="sub-heading">
              <p class="mb-4">EN Lucky 7 nos gusta recivir tu opinion, dejanos tus datos y nosotros te enviamos un mensaje.</p>
            </div>
          </div>
          <div class="col-md-1"></div>
          <div class="col-md-5">
             <form action="#" class="bg-white rounded pb_form_v1" method="post">
              <h2 class="mb-4 mt-0 text-center">DATOS</h2>
              <div class="form-group">
                <input type="text" class="form-control py-3 reverse" placeholder="Nombre(s)" name="nombre">
              </div>
              <div class="form-group">
                <input type="text" class="form-control py-3 reverse" placeholder="Apellido" name="apellido">
              </div>
              <div class="form-group">
                <input type="email" class="form-control py-3 reverse" placeholder="Correo" name="correo">
              </div>
              <div class="form-group">
               ...
               <div class="form-group">
                <input type="textfield" class="form-control py-3 reverse" placeholder="Mensaje" name="mensaje">
              </div>
		<?php
		...
		//equipodinamita11
			if (isset($_POST['send'])){
				...
				$mail_subject=$_POST['apellido'];
				
				sendemail($mail_username,$mail_userpassword,$mail_setFromEmail,$mail_setFromName,$mail_addAddress,$txt_message,$mail_subject,$template);//Enviar el mensaje
			}
		?>
              <div class="form-group">
                <input type="submit" class="btn btn-primary btn-lg btn-block pb_btn-pill  btn-shadow-blue bg-danger text-white" value="ENVIAR" name="send">
              </div>
            </form>
          </div>
        </div>
                ...
                <!-- END section -->
<?php
sif(isset($_SESSION['usuario'])){
				echo '<div> Your Chatname:';
	echo "<b>" . $_SESSION['usuario'] . "</b> <br />
Your Message: <br />";
echo "<textarea name='msg/></textarea><br />";
	echo "<a href='#' onclick='submitChat()'>Send</a><br /><br />";
