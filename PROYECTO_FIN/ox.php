...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h2 style="text-align:center;">Ticket para hacer el deposito en OXXO</h2> 
	  <div class="oxxo">
	  	<div><img src="img/logo.png" width="100%" ></div>
	  	<div><img src="img/oxxo.png"></div>
	  </div>
                  <span>Imprime y presenta este comprobante en cualquier tienda Oxxo del pais para realizar el pago por la compra. Indica al cajero de la tienda el valor exacto que figura en el presente comprobante. De lo contrario es probable que no podamos validar correctamente la compra. </span>
                       ...
                       ?>
                        ...
                        <tr>
                            <td>
                                ...
                                <label id="to"><?php 
                                       echo $SUMA = $_SESSION['total2'] + $res + $envio; 
                                       $_SESSION['suma'] = $SUMA; 
                                       ?></label>
                            </td>
                        </tr>
   ...
   <center>
                ...
                <a class="enviar" href="envios.php">Datos de Envio</a>
                <a class="enviar" href="pais.php">Volver</a>
           </center>
</div>
