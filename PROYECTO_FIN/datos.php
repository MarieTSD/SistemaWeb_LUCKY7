                   ...
                   <table>
                       <tr>  
                           <td>
                               ...
                               <br> <br>
                                <div>
                                   <input class="rad" type="radio"  name="tarjeta"> 
                                   <label class="css-label" for="identificador_input"><img src="img/santander.png" width="150px"></input>

                                   <input class="rad" type="radio" name="tarjeta"> 
                                   <label  class="css-label" for="identificador_input"><img src="img/bancomer.png" width="80px"></input>
                                    
                                   <input  class="rad" type="radio" name="tarjeta"> 
                                   <label  class="css-label" for="identificador_input" for="card"><img src="img/vexi.png" width="80px"></input>
                                </div>
                               <hr>
                           </td>
                       </tr>
                        <tr>   
                           <td>
                               ...
                               <input type="number" min="1000000000000000" max="9999999999999999" id="number" required
                                  oninvalid="setCustomValidity('Numero de tarjeta no valido')" 
                                    oninput="setCustomValidity('')"/><br /><br />
                            </td>
                       </tr>
                       <tr>
                          <td>
                           <label for="Security">NIP: </label>
                           <input type="number" min="1000" max="9999" id="code" required 
                           oninvalid="setCustomValidity('Pin No valido')" 
                           oninput="setCustomValidity('')"/><br /><br />
                           <hr>
                          </td>
                        </tr>
                        <tr>
                            <td>
                                <label for="compra">Subtotal de compra: </label>
                                <label name="compra">$<?php echo $_SESSION['total2']; ?></label>
                            </td>
                        </tr>
                        <?php
                       ...
                       ?>
                        <tr>
                            <td>
                                <label for="Cupon">Descuento por Cupones: </label>
                                <label name="Cupon">$ <?php 
                                    if($_SESSION['codigo'] == "M&A191018"){
                                        $desc = .15;        
                                    }else if($_SESSION['codigo'] == "BBB24K"){
                                        $desc = .30;
                                    }else if($_SESSION['codigo'] == "JARNBAM7"){
                                        $desc = .40;
                                    }else{
                                        $desc = 0; 
                                    }
                                    $sub=$_SESSION['total2']*$desc;
                                    echo $sub; 
                                    $_SESSION['descuento']=$sub;
                                    //$total= $_SESSION['total'];
                                   // $_SESSION['total2'] = $total - $sub; 
                                    ?></label>
                            </td>
                        </tr>
                        <?php 
...
<!--
                        <tr>
                            <td>
                                <label for="compra">Subtotal: </label>
                                <label name="compra">$<?php echo $_SESSION['total2']; ?></label>
                            </td>
                        </tr>
-->
                         <tr>
                            <td>
                                ...
                                <label id="iva">$<?php 
                                            if($_SESSION['pais'] == "Mexico" || $_SESSION['pais'] == "mexico" || $_SESSION['pais'] == "MEXICO")
                                            {
                                                $IVA = .16;
                                                $envio = 0; 
                                            }else if($_SESSION['pais'] == "Colombia" || $_SESSION['pais'] == "colombia" || $_SESSION['pais'] == "COLOMBIA"){
                                                $IVA = .19;
                                                $envio = 1000; 
                                            }
                                            $res = $_SESSION['total2'] * $IVA; 
                                            echo $res; 
                                           $_SESSION['impuestos'] = $res;
                                       ?></label>
                            </td>
                        </tr>
                         <tr>
                            <td>
                                <label for="envio">Gasto de envio: </label>
                                <label id="envio">$<?php 
                                        echo $envio; 
                                       ?></label>
                            </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <label id="to"><?php 
                                       echo $SUMA = $_SESSION['total2'] + $res + $envio - $sub; 
                                       $_SESSION['suma'] = $SUMA; 
                                       ?></label>
                            </td>
                        </tr>
