...
<!-- Codigo LOGIN-->  
   ...
   <!-- Hero section -->
        ...
        <section class="paiseccion cambiafondo">
            <h2 class="enc">Selecciona Pais </h2>
            <form action="formadepago.php" action="ox.php" method="post">
               <center>
                  <table>
                   <tr>
                   <td>
                        <select class="pa" name="pais" id="pais">
                            <option name="op" value="Mexico">Mexico</option>
                            <option name="op" value="Colombia">Colombia</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td>
                       <br <br>
                        <p style="color: white;">Si cuenta con cupones inserte el codigo</p>
                        <br>
                ...
                <tr>
                    <td>
                        <input type="text" name="codigo" id="codigo" placeholder="Ingresa codigo de cupon">
                    </td>
                </tr>
                <tr>
                   <td>
