...
<!-- Codigo LOGIN-->  
   ...
   <!-- Characteristics section -->
    <section class="characteristics">
      <h1 class="characteristics__title animated infinite flash" style="color:white;">DAMA</h1>
...
?>
    ...
    <section class="characteristics">
      <h1 class="characteristics__title animated infinite flash" style="color:white;">CABALLERO</h1>
      
      <section class="characteristics__container" style="display: flex; padding: 0px 40px; max-width: 1100px
       margin: 0px;
       flex-wrap: wrap;">
       <?php
$result = mysqli_query($con,"SELECT * FROM `prod` WHERE categoria LIKE 'caballero' AND existencia >0 ");
while($row = mysqli_fetch_assoc($result)){
		?>
	<article class="characteristics__item; card">
		  <ul class="list-group list-group-flush">
