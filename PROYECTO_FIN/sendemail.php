...
function sendemail($mail_username,$mail_userpassword,$mail_setFromEmail,$mail_setFromName,$mail_addAddress,$txt_message,$mail_subject, $template){
	...
	if(!$mail->send()) {
		...
		//echo 'Error de correo: ' . $mail->ErrorInfo."</p>";
              ...
              echo '<center>';
		      echo  '<div class="alert alert-warning alert-dismissible fade show" role="alert">';
              echo '<strong>Se ha enviado el codido de debloqueo a tu correo, Ingresa codigo de debloqueo en:</strong> <a href="recuperacion.php" class="alert-link">Pagina Recuperacion</a>';
              echo '<button type="button" class="close" data-dismiss="alert" aria-label="Close">';
              echo    '<span aria-hidden="true">&times;</span>';
              echo  '</button>';
              echo   '</div>';
