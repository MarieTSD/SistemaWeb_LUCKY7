...
<!-- Codigo LOGIN-->  
   ...
   <!-- Hero section -->
    <section class="hero3 hero4">
     	<!--SMACSS-->
     	<!--BEM BLOVK ELEMENT MODIFIER-->
      <h1 class="hero__title">MISION</h1>
      <p class="hero__paragraph">Ofrecer a nuestros clientes  productos de calidad, a precios cómodos  que cumplan con sus necesidades y exigencias, abarcando sus gustos de acuerdo a su estilo de ver y vivir la vida.</p>
    </section>
    <!-- End Hero section -->
