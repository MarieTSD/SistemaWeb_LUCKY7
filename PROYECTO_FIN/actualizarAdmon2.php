     ...
     $sql2 = "select * from prod where id='$modificar'";//hacemos cadena con la sentencia mysql que consulta todo el contenido de la tabla
      $resultado = $conexion -> query($sql2); //aplicamos sentencia  
         ...
         if(isset($_POST['submit'])){
            ...
            $cuatro = $_POST["ExA"];
            $cinco = $_POST["preA"];
            $seis = addslashes(file_get_contents($_FILES['imA']['tmp_name']));
            $siete = $_POST["tallaA"];
            $ocho = $_POST["categoria"];
            //$validar2 = $_SESSION['va'];
            //alert("hola");
            $modificar = $_SESSION["mod"];
//             if($validar == $validar2){
//                $ocho = $validar2;
...
//                $ocho = $validar;
//            }
            $ne="update prod set id='$uno',nombre='$dos',descripcion='$tres', existencia = '$cuatro', precio='$cinco', imagen='$seis', talla='$siete', categoria='$ocho' WHERE id='$modificar'";
            $fin = $conexion -> query($ne);
             if ($conexion->affected_rows >= 1){ 
                   $_SESSION['exito2'] = "si";
                    header("Location: ActualizarAdmon.php");
                }//fin
            //header("Location: actualizarAdmon.php");
         }
  }
...
<!--      <h1 class="hero__title"></h1>-->
      ...
      <form class="contact100-form validate-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data" method="post" id="alta">
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input class="input100" type="number" name="idA" value="<?php echo $_SESSION["id"]; ?>">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Nombre Producto:</span>
					<input class="input100" type="text" name="nomA" value="<?php echo $_SESSION["nombre"]; ?>">
					<span class="focus-input100"></span>
				</div>
               
                <div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Precio:</span>
					<input class="input100" type="number" name="preA" value="<?php echo $_SESSION["precio"]; ?>">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Existencia:</span>
					<input class="input100" type="number" name="ExA" value="<?php echo $_SESSION["existencia"]; ?>">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">Talla:</span>
					<input class="input100" type="text" name="tallaA" value="<?php echo $_SESSION["talla"]; ?>">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					<span class="label-input100">Descripcion:</span>
					<input class="input100" type="text" name="desA" value="<?php echo $_SESSION["descripcion"]; ?>" placeholder="Descripcion del producto" required>
<!--					<textarea class="input100" name="desA" value=""></textarea>-->
					<span class="focus-input100"></span>
				</div>
                <div class="wrap-input100 validate-input" data-validate = "Message is required">
					<span class="label-input100">Categoria:</span>
					<span><?php  echo $_SESSION['categoria'];
                            //$_SESSION['va']=$_SESSION['categoria'];
                        ?></span>
					<select name="categoria" id="alta" class="input100">
				...
				<div class="wrap-input100 validate-input" data-validate = "Message is required">
				    ...
				    <img class="bitch" src="data:image/jpg;base64, <?php echo base64_encode($_SESSION['imagen']);?>" alt="">
