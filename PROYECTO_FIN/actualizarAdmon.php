...
<!-- Codigo LOGIN-->  
   ...
   <?php
                      if($_SESSION['exito2'] == "si"){
                          echo '<script>swal("Actualizacion Exitosa", "Continua Actualizando productos", "success");</script>';
//                          echo '<center>';
//                          echo '<br>';
//                          echo  '<div class="alert alert-warning alert-dismissible fade show" role="alert">';
//                          echo '<strong>¡Actualizacion exitosa! Se realizaron los cambios correctamente</strong>';
  ...
  if($conexion->connect_error){
     ...
     $sql2 = "select * from prod where id='$modificar'";//hacemos cadena con la sentencia mysql que consulta todo el contenido de la tabla
      ...
      $fila = $resultado -> fetch_assoc();
                      if($fila){ 
                          //echo "HOLAAAAA";
                          //header('Location: actualizarAdmon2.php');
                          echo "<script>
                            document.location='actualizarAdmon2.php';
                            </script>";
                      }else{
                           echo '<script>swal("Producto no encontrado", "El id de producto que introduciste no esta asosciado a ninguno de nuestros productos", "error");</script>';
//                          echo '<center>';
//                          echo '<br>';
//                          echo  '<div class="alert alert-warning alert-dismissible fade show" role="alert">';
