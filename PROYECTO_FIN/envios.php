...
<!-- Codigo LOGIN-->  
   ...
   <!-- Hero section -->
        ...
        <section class="pagoseccion cambiafondo">
           <center>
    <table>
        <tr>
            <td>
            <form name="forma" action="nota.php" method="post">
                
                <legend>¿Donde quieres que se envie tu Pedido?</legend>
                    <table>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <input type="text" name="nombre" required onkeypress="return sololetras(event)" onpaste = "return false" oninvalid="setCustomValidity('Ingresa Nombre para continuar')" 
                        ...
                        <tr>
                            <td>
                                <label for="direccion">Direccion de email (Valoramos tu privacidad)</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="email" name="correo" required oninvalid="setCustomValidity('Correo Invalido')" 
                                    oninput="setCustomValidity('')"/><br /><br />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <input type="text" name="ciudad" required onkeypress="return sololetras(event)" onpaste ="return false" oninvalid="setCustomValidity('Ingresa ciudad para continuar')" 
                                    oninput="setCustomValidity('')"/><br /><br />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <label name="pais"><?php echo $_SESSION['pais'];?></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <input type="number" min="10000" max="99999" name="codigo" required
                                oninvalid="setCustomValidity('Codigo postal invalido')" 
                                    oninput="setCustomValidity('')"/><br /><br />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <input type="number" min="4490000000" max="4499999999" name="telefono" required
                                oninvalid="setCustomValidity('Numero de telefono no valido')" 
                                    oninput="setCustomValidity('')"/><br /><br />
                            </td>
                        </tr>
