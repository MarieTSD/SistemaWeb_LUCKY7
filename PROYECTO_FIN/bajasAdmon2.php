...
//                document.location='bajas.php';
//                } 
//                else{ docuement.location='bajasAdmon2.php'; 
//                }</script>";
...
<!--      <h1 class="hero__title"></h1>-->
      <p class="hero__paragraph">Datos del producto a eliminar</p>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
          <table class="table table-hover table-bordered">
              ...
              <tr>
                  <td>Existencia: </td>
                  <td><?php echo $_SESSION['existencia']; ?></td>
              </tr>
              <tr>
                  <td>Precio: </td>
              ...
              <tr>
                  <td>Imagen</td>
                  <td> <img class="bitch" src="data:image/jpg;base64, <?php echo base64_encode($_SESSION['imagen']);?>" alt=""> </td>
              </tr>
              <tr>
                  <td>Talla: </td>
                  <td><?php echo $_SESSION['talla']; ?></td>
              </tr>
              <tr>
                  <td>Categoria: </td>
