...
<!--					<span class="label-input100">ID:</span>-->
					<input class="input100" type="email" name="correo" placeholder="Ingresa tu correo electronico">
     ...
     $BaseD = 'lucky7';
      ...
      if(isset($_POST['submit'])){
          ...
          if($correo == $modificar){
              ...
              $cadena2 = array();
              $array = array("A", "B", "C", "D","1","2","3","4","5","6","7","8","9","E","F","G","H","I","J","K","L","M","N","O","P","Q","R","S","T","U","V","W","Y","Z");
              for($i=0; $i<8; $i++){
                  $cadena2[$i] = $array[$numero[$i]];
              }
              $cadena = implode($cadena2);
              $ne="update usuario set codigoDes='$cadena' WHERE correo='$modificar'";
            $fin = $conexion -> query($ne);
              include("sendemail.php");//Mando a llamar la funcion que se encarga de enviar el correo electronico
				...
				$template="plantillaRecuCorreo.html";//Ruta de la plantilla HTML para enviar nuestro mensaje
               ...
               echo '<script>swal("Error", "Tu correo no esta registrado", "error");</script>';
//              echo '<center>';
//                          echo '<br>';
