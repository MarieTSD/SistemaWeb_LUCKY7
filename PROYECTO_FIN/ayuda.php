...
<!-- menu -->
    ...
    <section class="introduction cambiafondo" style="background: white; color: #ffcc00;">
		<h1 class="introduction__title">PREGUNTAS FRECUENTES</h1>
    </section>

<div class="acordion">

<button class="accordion">GUÍA DE TALLAS</button>
<div class="panel"><img src="img/medidas-Elisa-Muresan.jpg" alt="">
</div>

<button class="accordion">CERTIFICADO GOTS</button>
<div class="panel">
  <p>Es uno de los certificados más importantes, puedes conocerlo <a href="https://www.global-standard.org/es/">aquí</a>.</p>
</div>

<button class="accordion">FÁCIL CUIDADO</button>
<div class="panel">
  <p>Son prendas que tienen un cuidado como cualquier otra prenda de algodón, se pueden lavar en lavadora en programas cortos a 30º y tienen un fácil planchado. No utilizar secadora. Como consejo general nuestro, recomendamos lavarla con jabones “eco” para mantener las propiedades de las prendas el mayor tiempo posible, no utilizar suavizantes. Si algún tejido necesitara de algún cuidado especial nuestro personal en tienda le avisará.</p>
</div> 
 
<button class="accordion">RESPETUOSOS CON EL PLANETA</button>
<div class="panel">
  <p>Esta concienciada totalmente con el respeto al medio ambiente. Nuestros tejidos ecológicos, están libres de químicos evitando el vertido de sustancias contaminantes, directamente o a través de filtraciones por la tierra en los cultivos o el lavado, a ríos, mares e incluso al agua potable o a la cadena alimenticia. Además, el hecho de no llevar los químicos de otras prendas, hace que respeten la piel, protegiendo de dermatitis, alergias o pieles sensibles. </p>
</div>
 
<button class="accordion">¿LOS PRECIOS DE LA TIENDA ONLINE Y DE LA TIENDA FÍSICA SON LOS MISMOS?</button>
<div class="panel">
  <p>No tendras que preocuparte por eso, ya que solo tenemos tienda online.</p>
</div>
  <button class="accordion">¿QUE DEBO HACER SI ME LLEGA ALGÚN PRODUCTO DEFECTUOSO O INCORRECTO?</button>
<div class="panel">
  <p>Si excepcionalmente te llegara algún producto defectuoso o incorrecto, ponte en contacto con nuestro departamento de atención al cliente en tiendaric21@lucky7.com</p>
</div>
  <button class="accordion">¿QUE FORMA DE PAGO PUEDO UTILIZAR PARA EFECTUAR MI COMPRA?</button>
<div class="panel">
  <p>Paypal</p>
<p>Tarjeta de credito</p>
</div>
<button class="accordion">¿CUANTO TIEMPO TARDARÁ EN LLEGAR MI PEDIDO?</button>
<div class="panel">
  <p>Por lo general de 2 a 3 dias laborables y como máximo en un plazo de 7 días laborables. Si recoges en tienda, en el mismo momento del pedido, a través de PAY PAL, la tendrás disponible, en caso de transferencia bancaria en el momento de recibir el pago.</p>
</div>
<button class="accordion">¿CUAL ES PROCESO DE LA ENTREGA EN TIENDA?</button>
<div class="panel">
  <p>Al hacer el pedido, en observaciones nos indicas que quieres recogerlo en tienda. En el momento que nosotros recibamos el pago te enviamos una email indicando que puedes pasar a recogerlo con el número de pedido que recibiras en un email.</p>
</div>
<button class="accordion">¿CUANTO HE DE PAGAR DE GASTOS DE ENVÍO?</button>
<div class="panel">
  <p>Para recoger en tienda es gratuito. Para el resto de envios 4,95€. En estos momentos no enviamos a las Islas Canarias, Ceuta y Melilla.</p>
</div>
		<button class="accordion">¿CUAL ES EL PLAZO PARA PODER REALIZAR UNA DEVOLUCIÓN O CAMBIO?</button>
<div class="panel">
  <p>Tienes 15 días para poder realizar cualquier devolución o cambio. Las prendas deberán estar en perfecto estado y no haber sido utilizadas.

Para las devoluciones se te devolverá el importe de la prenda menos los gastos de envío inicialmente abonados. Los gastos de devolución corren a cargo del cliente. </p>
</div>
  <button class="accordion">¿COMO DEBO HACER PARA DEVOLVER O CAMBIAR UN ARTICULO?</button>
<div class="panel">
  <p>Te pones en contacto con nosotros a través de tiendaric21@lucky7.com para indicarnos que prenda nos envías y cual quieres que te enviemos. Nos envías la prenda en la misma caja que te llego a la siguiente dirección, Pedro María Ric 21, 50008 Zaragoza, nosotros revisaremos la prenda y te enviaremos la nueva prenda.

No admitiremos ninguna prenda devuelta a contrareembolso.</p>
</div>
  <button class="accordion">¿COMO RECIBIRE EL IMPORTE DE LA DEVOLUCION?</button>
<div class="panel">
  <p>Por el mismo método del pago.</p>
</div>
